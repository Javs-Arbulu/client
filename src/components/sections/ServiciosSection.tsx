...
export default function ServiciosSection() {
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-slate-50 dark:from-slate-800 to-transparent"></div>
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="border-0 shadow-xl hover:shadow-3xl dark:shadow-slate-800/30 dark:hover:shadow-slate-800/50 transition-all duration-500 hover:-translate-y-3 bg-gradient-to-br from-slate-50 via-white to-slate-50/50 dark:from-slate-800 dark:via-slate-700 dark:to-slate-800/50 group overflow-hidden relative">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-cyan-300 via-cyan-400 to-blue-400 dark:from-cyan-400 dark:via-cyan-300 dark:to-blue-300"></div>
            <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-cyan-50/30 dark:to-cyan-900/20 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            <CardContent className="p-12 text-center relative z-10">
              <div className="w-24 h-24 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-600 dark:from-cyan-600 dark:via-cyan-500 dark:to-blue-600 rounded-3xl flex items-center justify-center mx-auto mb-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-2xl shadow-slate-900/20 dark:shadow-cyan-500/20">
